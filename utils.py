...
# Wrappers inherit from Object, which is an object with __eq__ and __hash__
# Other methods that Object will require may be determined based on the usage.
# Here, we included __eq__ and __hash__ because these two methods are required
# by the hash table contract.
# Note: the only two requirements are the hashtable contract 
# implement __eq__, and implement __hash__
class Object:
...
#
#
# TODO: Regex parser and identifier
